...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className='h-full relative z-20 w-1/3 rounded-2xl  p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center'>
        <Image
          src={domainURL('/wallet/nova.svg')}
          alt='avatar'
          height='100'
          width='100'
          className='rounded-full h-10 w-10'
